  ...
  "blocks": [
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "difficulty": "advanced",
          "question": "若 \\(|x - a|  0\\)）的解集为 \\(\\{x \\mid -1 < x < 5\\}\\)，求 \\(a\\) 和 \\(b\\) 的值。",
