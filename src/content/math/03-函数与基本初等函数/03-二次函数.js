  ...
  "blocks": [
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "与 \\(x\\) 轴交点",
          "\\(\\Delta > 0\\)：两个交点；\\(\\Delta = 0\\)：一个交点；\\(\\Delta\)"
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "title": "五、\"三个二次\"的关系",
      "paragraphs": [
        "二次函数 \\(y = ax^2+bx+c\\)、一元二次方程 \\(ax^2+bx+c=0\\)、一元二次不等式 \\(ax^2+bx+c > 0\\)（或 \\(• 方程的解 \\(\\Leftrightarrow\\) 函数图像与 \\(x\\) 轴交点的横坐标\n\n      • 不等式的解集 \\(\\Leftrightarrow\\) 函数图像在 \\(x\\) 轴上方（或下方）对应的 \\(x\\) 范围\)"
      ]
    },
    {
      "type": "example",
      ...
      "items": [
        ...
        },
        {
          ...
          "solution": "解：\n\n        （1）将 \\(f(x)\\) 因式分解：\n\n        $$f(x) = x^2 - (a-1)x - a = (x - a)(x + 1)$$\n\n        所以方程 \\(f(x) = 0\\) 的两根为 \\(x_1 = a\\)，\\(x_2 = -1\\)。\n\n        由韦达定理，两根之和 \\(x_1 + x_2 = a - 1\\)。\n\n        由题意 \\(a - 1 = 2\\)，解得 \\(a = 3\\)。\n\n        （2）不等式 \\(f(x) = (x - a)(x + 1) 因为二次项系数为 1（开口向上），\"\\(① 当 \\(a > -1\\) 时，解集为 \\((-1, a)\\)；\n\n        ② 当 \\(a = -1\\) 时，\\(f(x) = (x+1)^2 ③ 当 \\(a < -1\\) 时，解集为 \\((a, -1)\\)。\)\)\)",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "answer": "答案：B。开口向下 \\(\\Rightarrow a  0\\)。"
        },
        {
          "difficulty": "medium",
