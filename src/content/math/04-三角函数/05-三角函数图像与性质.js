      ...
      "items": [
        {
          ...
          "answer": "周期 \\(T = \\pi\\)，最大值 \\(3\\)，最小值 \\(-3\\)，取最大值时 \\(x = \\frac{\\pi}{8} + k\\pi\\)（\\(k \\in \\mathbb{Z}\\)）"
        },
        {
          "title": "例题2：图像变换",
          ...
          "answer": "方法一（先平移后伸缩）：右移 \\(\\frac{\\pi}{3}\\) → 横坐标缩为 \\(\\frac{1}{2}\\) → 纵坐标伸为 \\(2\\) 倍；方法二（先伸缩后平移）：横坐标缩为 \\(\\frac{1}{2}\\) → 右移 \\(\\frac{\\pi}{6}\\) → 纵坐标伸为 \\(2\\) 倍"
        },
        {
          "title": "例题3：由图像求解析式",
          ...
          "answer": "\\(y = 2\\sin\\left(x + \\frac{\\pi}{3}\\right)\\)"
        },
        {
          ...
          "answer": "由 \\(\\omega T = 2k\\pi\\) 取 \\(k=1\\) 得最小正周期 \\(T = \\frac{2\\pi}{\\omega}\\)，得证"
        },
        {
          ...
          "answer": "原解法错误。应横坐标缩为 \\(\\frac{1}{2}\\) 后，再左移 \\(\\frac{\\pi}{6}\\)（即 \\(\\frac{\\varphi}{\\omega} = \\frac{\\pi/3}{2}\\)），得 \\(y = \\sin\\left(2x + \\frac{\\pi}{3}\\right)\\)"
        }
      ]
    },
    {
